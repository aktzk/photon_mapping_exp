...
impl Scene {
    ...
    pub fn new() -> Self {
        ...
        spheres.push(Sphere::new(
            7.0,
            DVec3::new(60.0, 55.0, 71.6),
            DVec3::new(17.0, 12.0, 4.0),
            DVec3::new(0.78, 0.78, 0.78),
            Reflection::Diffuse,
        ));
        spheres.push(Sphere::new(
            13.0,
            DVec3::new(50.0, 15.0, 81.6),
